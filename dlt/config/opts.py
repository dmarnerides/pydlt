...
parse.param_dict = {
    ...
    'scheduler': [ dict(flags=['--lr_schedule'], choices=['plateau', 'step', 'none'], default='step', help='Learning rate schedule'),
                     ...
                     dict(flags=['--overwrite_scheduler_chkp'], type=str2bool, default=True, help='Overwrite scheduler checkpoints'),
                     dict(flags=['--timestamp_scheduler_chkp'], type=str2bool, default=False, help='Add timestamp to scheduler checkpoints'),
                     dict(flags=['--count_scheduler_chkp'], type=str2bool, default=True, help='Add count to scheduler checkpoints')],
